define(['d3-selection', 'd3-force', 'd3-zoom', 'd3-drag', 'd3-timer', 'd3-ease', 'd3-interpolate', 'utils/math', 'forcegraph/draw', 'helper'],
  function (d3Selection, d3Force, d3Zoom, d3Drag, d3Timer, d3Ease, d3Interpolate, math, draw, helper) {
    'use strict';
    ...
    return function (sidebar) {
      ...
      force = d3Force.forceSimulation()
        ...
        .force('collide', d3Force.forceCollide().radius(33))
        .on('tick', redraw)
        .alphaDecay(0.025);
      ...
      self.setData = function setData(data) {
        ...
        intLinks = data.links.filter(function (d) {
          ...
          return {
            ...
            color: helper.linkColor(d, 'source'),
            color_to: helper.linkColor(d, 'target')
          };
        });

define(['helper'], function (helper) {
  ...
  return function (language) {
    ...
    self.setData = function setData(d) {
      ...
      var totalPercentage = (totalOnlineNodes / totalNodes * 100);
      ...
      stats.textContent = _.t('sidebar.nodes', { total: totalNodes, online: totalOnlineNodes, percent_online: totalPercentage.toFixed(2) }) + ' ' +
